...
models <- lapply(1:length(formulas), 
                 function(i) {
                   ...
                   save(model, file = paste0("output_new2/select_model_region_cov/cov_",region[j], lab[i],".RData"))})
...
for(i in 1:length(formulas)){
  ...
  load(paste0("output_new2/select_model_region_cov/cov_",region[j],lab[i],".RData"))
...
models <- lapply(1:length(formulas.best), 
                 function(i) {
                   ...
                   save(model, file = paste0("output_new2/select_model_region_cov/cov_",region[j], lab.best[i],".RData"))})
...
for(i in 1:length(formulas.best)){
  ...
  load(paste0("output_new2/select_model_region_cov/cov_",region[j],lab.best[i],".RData"))
...
table0.best.out$load=c(paste0("output_new2/select_model_region_cov/cov_",region[j],"model1.1",".RData"),
                       paste0("output_new2/select_model_region_cov/cov_",region[j],"model1.2",".RData"),
                       paste0("output_new2/select_model_region_cov/cov_",region[j],"model1.3",".RData"),
                       paste0("output_new2/select_model_region_cov/cov_",region[j],"model1.4",".RData"))
...
########export
library(writexl)
write_xlsx(table2d.list.Denmark, "output_new2/select_model_region_cov/table2d.list.Denmark.xlsx")
write_xlsx(coef.list.Denmark, "output_new2/select_model_region_cov/coef.list.Denmark.xlsx")
write_xlsx(vcov.list.Denmark, "output_new2/select_model_region_cov/vcov.list.Denmark.xlsx")

write_xlsx(table2d.list.Ireland, "output_new2/select_model_region_cov/table2d.list.Ireland.xlsx")
write_xlsx(coef.list.Ireland, "output_new2/select_model_region_cov/coef.list.Ireland.xlsx")
write_xlsx(vcov.list.Ireland, "output_new2/select_model_region_cov/vcov.list.Ireland.xlsx")

write_xlsx(table2d.list.Portugal, "output_new2/select_model_region_cov/table2d.list.Portugal.xlsx")
write_xlsx(coef.list.Portugal, "output_new2/select_model_region_cov/coef.list.Portugal.xlsx")
write_xlsx(vcov.list.Portugal, "output_new2/select_model_region_cov/vcov.list.Portugal.xlsx")

write_xlsx(table2d.list.Slovenia, "output_new2/select_model_region_cov/table2d.list.Slovenia.xlsx")
write_xlsx(coef.list.Slovenia, "output_new2/select_model_region_cov/coef.list.Slovenia.xlsx")
write_xlsx(vcov.list.Slovenia, "output_new2/select_model_region_cov/vcov.list.Slovenia.xlsx")

write_xlsx(table2d.list.England, "output_new2/select_model_region_cov/table2d.list.England.xlsx")
write_xlsx(coef.list.England, "output_new2/select_model_region_cov/coef.list.England.xlsx")
write_xlsx(vcov.list.England, "output_new2/select_model_region_cov/vcov.list.England.xlsx")
