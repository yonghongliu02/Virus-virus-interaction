...
models <- lapply(1:length(formulas), 
                 function(i) {
                   ...
                   save(model, file = paste0("output_new/select_model_region_iav/iav_",region[j], lab[i],".RData"))})
...
for(i in 1:length(formulas)){
  ...
  load(paste0("output_new/select_model_region_iav/iav_",region[j],lab[i],".RData"))
...
models <- lapply(1:length(formulas.best), 
                 function(i) {
                   ...
                   save(model, file = paste0("output_new/select_model_region_iav/iav_",region[j], lab.best[i],".RData"))})
...
for(i in 1:length(formulas.best)){
  ...
  load(paste0("output_new/select_model_region_iav/iav_",region[j],lab.best[i],".RData"))
...
table0.best.out$load=c(paste0("output_new/select_model_region_iav/iav_",region[j],"model1.1",".RData"),
                       paste0("output_new/select_model_region_iav/iav_",region[j],"model1.2",".RData"),
                       paste0("output_new/select_model_region_iav/iav_",region[j],"model1.3",".RData"),
                       paste0("output_new/select_model_region_iav/iav_",region[j],"model1.4",".RData"))
...
########export
library(writexl)
write_xlsx(table2d.list.Denmark, "output_new/select_model_region_iav/table2d.list.Denmark.xlsx")
write_xlsx(coef.list.Denmark, "output_new/select_model_region_iav/coef.list.Denmark.xlsx")
write_xlsx(vcov.list.Denmark, "output_new/select_model_region_iav/vcov.list.Denmark.xlsx")

write_xlsx(table2d.list.Ireland, "output_new/select_model_region_iav/table2d.list.Ireland.xlsx")
write_xlsx(coef.list.Ireland, "output_new/select_model_region_iav/coef.list.Ireland.xlsx")
write_xlsx(vcov.list.Ireland, "output_new/select_model_region_iav/vcov.list.Ireland.xlsx")

write_xlsx(table2d.list.Portugal, "output_new/select_model_region_iav/table2d.list.Portugal.xlsx")
write_xlsx(coef.list.Portugal, "output_new/select_model_region_iav/coef.list.Portugal.xlsx")
write_xlsx(vcov.list.Portugal, "output_new/select_model_region_iav/vcov.list.Portugal.xlsx")

write_xlsx(table2d.list.Slovenia, "output_new/select_model_region_iav/table2d.list.Slovenia.xlsx")
write_xlsx(coef.list.Slovenia, "output_new/select_model_region_iav/coef.list.Slovenia.xlsx")
write_xlsx(vcov.list.Slovenia, "output_new/select_model_region_iav/vcov.list.Slovenia.xlsx")

write_xlsx(table2d.list.England, "output_new/select_model_region_iav/table2d.list.England.xlsx")
write_xlsx(coef.list.England, "output_new/select_model_region_iav/coef.list.England.xlsx")
write_xlsx(vcov.list.England, "output_new/select_model_region_iav/vcov.list.England.xlsx")
...
for(i in 1:nrow(time)){
  ...
  casestopred <- data$MA3_Aflu # response variable
  ...
  save(preds, file = paste0("output_new/preds_iav_rsv_slovenia/preds_",2020 + time[i,2], "_", time[i,1], ".RData"))
...
for(i in 1:nrow(time)){    
  ...
  load(paste0("output_new/preds_iav_rsv_slovenia/preds_",2020 + time[i,2],"_",time[i,1],".RData"))
...
ggplot(data) + 
  ...
  geom_line(aes(x = yearweek, y = MA3_Aflu, col = "#499894")) +
...
write.csv(table0,"output_new/preds_iav_rsv_slovenia/iav.csv")
write.csv(data,"output_new/preds_iav_rsv_slovenia/iav-data.csv")




###combine 5 results
df1<-read.csv("output_new/preds_iav_rsv_denmark/iav-data.csv")
df2<-read.csv("output_new/preds_iav_rsv_ireland/iav-data.csv")
df3<-read.csv("output_new/preds_iav_rsv_portugal/iav-data.csv")
df4<-read.csv("output_new/preds_iav_rsv_slovenia/iav-data.csv")
df5<-read.csv("output_new/preds_iav_rsv_england/iav-data.csv")
...
ggplot(finaldf) + 
  ...
  geom_line(aes(x = yearweek, y = MA3_Aflu, col = "#499894",group=subregion)) +
  scale_colour_identity(name = "",
                        breaks = c("#499894", "#D37295"),
                        labels = c("Observed", "Posterior predicted"),
                        guide = "legend") +
