...
models <- lapply(1:length(formulas), 
                 function(i) {
                   ...
                   save(model, file = paste0("output_new/select_model_region_rsv/rsv_",region[j], lab[i],".RData"))})
...
for(i in 1:length(formulas)){
  ...
  load(paste0("output_new/select_model_region_rsv/rsv_",region[j],lab[i],".RData"))
...
models <- lapply(1:length(formulas.best), 
                 function(i) {
                   ...
                   save(model, file = paste0("output_new/select_model_region_rsv/rsv_",region[j], lab.best[i],".RData"))})
...
for(i in 1:length(formulas.best)){
  ...
  load(paste0("output_new/select_model_region_rsv/rsv_",region[j],lab.best[i],".RData"))
...
table0.best.out$load=c(paste0("output_new/select_model_region_rsv/rsv_",region[j],"model1.1",".RData"),
                       paste0("output_new/select_model_region_rsv/rsv_",region[j],"model1.2",".RData"),
                       paste0("output_new/select_model_region_rsv/rsv_",region[j],"model1.3",".RData"),
                       paste0("output_new/select_model_region_rsv/rsv_",region[j],"model1.4",".RData"))
...
all.plot<-ggplot(all.df, aes(x=lag,y=(Var2),  z=Freq)) +
  ...
  labs(title = paste0("RSV-",region[j]) )+
...
########export
library(writexl)
write_xlsx(table2d.list.Denmark, "output_new/select_model_region_rsv/table2d.list.Denmark.xlsx")
write_xlsx(coef.list.Denmark, "output_new/select_model_region_rsv/coef.list.Denmark.xlsx")
write_xlsx(vcov.list.Denmark, "output_new/select_model_region_rsv/vcov.list.Denmark.xlsx")

write_xlsx(table2d.list.Ireland, "output_new/select_model_region_rsv/table2d.list.Ireland.xlsx")
write_xlsx(coef.list.Ireland, "output_new/select_model_region_rsv/coef.list.Ireland.xlsx")
write_xlsx(vcov.list.Ireland, "output_new/select_model_region_rsv/vcov.list.Ireland.xlsx")

write_xlsx(table2d.list.Portugal, "output_new/select_model_region_rsv/table2d.list.Portugal.xlsx")
write_xlsx(coef.list.Portugal, "output_new/select_model_region_rsv/coef.list.Portugal.xlsx")
write_xlsx(vcov.list.Portugal, "output_new/select_model_region_rsv/vcov.list.Portugal.xlsx")

write_xlsx(table2d.list.Slovenia, "output_new/select_model_region_rsv/table2d.list.Slovenia.xlsx")
write_xlsx(coef.list.Slovenia, "output_new/select_model_region_rsv/coef.list.Slovenia.xlsx")
write_xlsx(vcov.list.Slovenia, "output_new/select_model_region_rsv/vcov.list.Slovenia.xlsx")

write_xlsx(table2d.list.England, "output_new/select_model_region_rsv/table2d.list.England.xlsx")
write_xlsx(coef.list.England, "output_new/select_model_region_rsv/coef.list.England.xlsx")
write_xlsx(vcov.list.England, "output_new/select_model_region_rsv/vcov.list.England.xlsx")
...
for(i in 1:nrow(time)){
  ...
  casestopred <- data$MA3_rsv # response variable
  ...
  save(preds, file = paste0("output_new/preds_rsv_iav_ireland/preds_",2020 + time[i,2], "_", time[i,1], ".RData"))
...
for(i in 1:nrow(time)){    
  ...
  load(paste0("output_new/preds_rsv_iav_ireland/preds_",2020 + time[i,2],"_",time[i,1],".RData"))
...
ggplot(data) + 
  ...
  geom_line(aes(x = yearweek, y = MA3_rsv, col = "#499894")) +
...
write.csv(table0,"output_new/preds_rsv_iav_ireland/rsv.csv")
write.csv(data,"output_new/preds_rsv_iav_ireland/rsv-data.csv")
...
ggplot(finaldf) + 
  ...
  geom_line(aes(x = yearweek, y = MA3_rsv, col = "#499894",group=subregion)) +
  scale_colour_identity(name = "",
                        breaks = c("#499894", "#D37295"),
                        labels = c("Observed", "Posterior predicted"),
                        guide = "legend") +
