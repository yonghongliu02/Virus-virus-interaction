...
models <- lapply(1:length(formulas), 
                 function(i) {
                   ...
                   save(model, file = paste0("../output_new/select_model_us_cov/cov_", lab[i],".RData"))})
...
for(i in 1:length(formulas)){
  ...
  load(paste0("../output_new/select_model_us_cov/cov_",lab[i],".RData"))
...
models <- lapply(1:length(formulas.best), 
                 function(i) {
                   ...
                   save(model, file = paste0("../output_new/select_model_us_cov/cov_", lab.best[i],".RData"))})
...
for(i in 1:length(formulas.best)){
  ...
  load(paste0("../output_new/select_model_us_cov/cov_",lab.best[i],".RData"))
...
######################## 9. compare MAE###########################
#basemodel
load("../output_new/select_model_us_cov/cov_basemodel.RData")
basemodel <- model
#best model
load("../output_new/select_model_us_cov/cov_model1.1.RData")
...
# for(i in 1:nrow(time)){
   ...
   save(preds, file = paste0("../output_new/preds_cov_iav/preds_",2020 + time[i,2], "_", time[i,1], ".RData"))
 ...
 for(i in 1:nrow(time)){    
   ...
   load(paste0("../output_new/preds_cov_iav/preds_",2020 + time[i,2],"_",time[i,1],".RData"))
...
table0.best.out$load=c("../output_new/select_model_us_cov/cov_model1.1.RData",
                       "../output_new/select_model_us_cov/cov_model1.2.RData",
                       "../output_new/select_model_us_cov/cov_model1.3.RData",
                       "../output_new/select_model_us_cov/cov_model1.4.RData")
...
########export
library(writexl)
write_xlsx(table2d.list, "../output_new/select_model_us_cov/table2d.list.xlsx")
write_xlsx(coef.list, "../output_new/select_model_us_cov/coef.list.xlsx")
write_xlsx(vcov.list, "../output_new/select_model_us_cov/vcov.list.xlsx")
