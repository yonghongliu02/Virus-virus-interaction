...
arranged_plot<-ggarrange(
  allplot.list[[1]], cumuplot.list[[1]], bestplotmin.list[[1]],
  allplot.list[[2]], cumuplot.list[[2]], bestplotmax.list[[2]],
  allplot.list[[3]], cumuplot.list[[3]], bestplotmax.list[[3]],
  allplot.list[[4]], cumuplot.list[[4]], bestplotmax.list[[4]],
  allplot.list[[5]], cumuplot.list[[5]], bestplotmax.list[[5]],
  allplot.list[[6]], cumuplot.list[[6]], bestplotmax.list[[6]],
  
  
  ncol = 3,  nrow = 6, align = 'hv',hjust=-2,
  labels = c("A", "B", "C",
             "D", "E", "F",
             "G", "H", "I",
             "A", "B", "C",
...
#ggsave("../figure_new/fig_epidemic_meta.pdf", plot = arranged_plot, width=28, height=36, units="cm")


write_xlsx(mvall.result.list, path = "../figure_new/epidemic_meta.xlsx")
